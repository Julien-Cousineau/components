...
export default class StyleGUIProgram extends Panel{
  constructor(options){
      super(options)
      if(!options._sprogram)console.warn("StyleGUIProgram needs a style pointer");
      const dummy = new StyleProgram();
      this._sprogram = options._sprogram || function(){return dummy};
  ...
  get sprogram(){return this._sprogram()}
