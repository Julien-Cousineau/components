...
export default class Checkbox {
  ...
  render(element){
    ...
    const div =  element.append('div').attr('class','form-check');
    const input = this.input = div.append('input').attr('class','form-check-input').attr('type','checkbox').attr('{0}'.format(value?'checked':'unchecked'),'');
